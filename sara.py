import speech_recognition as sr  # recognise speech (pip install SpeechRecognition)
import playsound  # to play an audio file (pip install playsound)
from gtts import gTTS  # google text to speech (pip install gtts)
import random
...
def speak(audio_string):
    ...
    print(f"sara: {audio_string}")  # print what app said
